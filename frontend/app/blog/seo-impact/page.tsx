            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="bg-purple-50 border border-purple-200 p-4 rounded-lg">
                  ...
                  <p className="text-sm">
                    Month-over-month growth in branded queries (your company name + variations). Strong features often
                    drive 15–30% lifts within 60 days.
                  </p>
                </div>

                <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                  <h4 className="font-semibold">Domain Authority Trend</h4>
                  <p className="text-sm">
              ...
              <h3 className="text-xl font-semibold mb-4">Advanced Metrics</h3>
              <div className="space-y-4 mb-8">
                <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                  <h4 className="font-semibold">Co-citation Analysis</h4>
                  <p className="text-sm">
                    Use tools like Ahrefs' "Competing Domains" or SEMrush's "Organic Competitors" to see if you're
                    appearing in similar contexts as category leaders.
                  </p>
                </div>

                <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                  <h4 className="font-semibold">SERP Feature Wins</h4>
                  <p className="text-sm">
                    Track featured snippets, "People Also Ask," and knowledge panel mentions that reference your
                    listicle features.
                  </p>
                </div>

                <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                  <h4 className="font-semibold">Secondary Link Velocity</h4>
                  <p className="text-sm">
                    Monitor how many additional links you earn from sites that discovered you through the original
                    listicle.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="border border-red-200 bg-red-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800">Problem: Low click-through from the listicle</h4>
                  <ul className="text-sm text-red-700 mt-2 space-y-1">
                    <li>• Your description is too generic or doesn't highlight unique value</li>
                    <li>• Competitors have more compelling "best for" tags</li>
                    <li>• Your link is buried at the bottom or in a less prominent position</li>
                  </ul>
                  <p className="text-sm text-red-700 mt-2">
                    <strong>Fix:</strong> Provide better positioning copy and visual assets for the next update.
                  </p>
                </div>

                <div className="border border-yellow-200 bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-800">Problem: Traffic comes but doesn't convert</h4>
                  <ul className="text-sm text-yellow-700 mt-2 space-y-1">
                    <li>• Landing page doesn't match the listicle's framing</li>
                    <li>• Visitors expect a free trial but hit a paywall</li>
                    <li>• Your site loads slowly or looks outdated compared to competitors</li>
                  </ul>
                  <p className="text-sm text-yellow-700 mt-2">
                    <strong>Fix:</strong> Create listicle-specific landing pages that continue the narrative.
                  </p>
                </div>

                <div className="border border-blue-200 bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-800">Problem: No measurable SEO impact</h4>
                  <ul className="text-sm text-blue-700 mt-2 space-y-1">
                    <li>• The listicle itself doesn't rank well</li>
                    <li>• Your link is nofollow or in a low-authority section</li>
                    <li>• You need more features to reach critical mass</li>
                  </ul>
                  <p className="text-sm text-blue-700 mt-2">
                    <strong>Fix:</strong> Focus on higher-authority targets and build a portfolio of 10+ features.
                  </p>
                </div>
              </div>

              <h2 className="text-2xl font-bold text-gray-900 mb-4">Action checklist: your next 30 days</h2>
              <div className="bg-slate-100 p-6 rounded-lg mb-8">
                <h3 className="font-semibold mb-4">Week 1: Foundation</h3>
                <ul className="space-y-2 text-sm">
                  <li>□ Audit current listicle mentions (use GetListicled or manual search)</li>
                  <li>□ Score your top 20 target publications using the profile checklist</li>
                  <li>□ Set up tracking for brand search volume and referral traffic</li>
                </ul>

                <h3 className="font-semibold mb-4 mt-6">Week 2: Asset Creation</h3>
                <ul className="space-y-2 text-sm">
                  <li>□ Build your standard asset pack (descriptions, images, specs)</li>
                  <li>□ Create 3 different "best for" positioning angles</li>
                  <li>□ Gather proof points (testimonials, test data, certifications)</li>
                </ul>

                <h3 className="font-semibold mb-4 mt-6">Week 3: Outreach</h3>
                <ul className="space-y-2 text-sm">
                  <li>□ Pitch 5 high-priority targets with personalized value</li>
                  <li>□ Follow up on any existing relationships or past features</li>
                  <li>□ Submit to 3 "open submission" listicles</li>
                </ul>

                <h3 className="font-semibold mb-4 mt-6">Week 4: Optimization</h3>
                <ul className="space-y-2 text-sm">
                  <li>□ Review early results and refine messaging</li>
                  <li>□ Create listicle-specific landing pages for confirmed features</li>
                  <li>□ Plan your 90-day refresh calendar</li>
                </ul>
              </div>

              <div className="bg-blue-600 text-white p-6 rounded-lg">
                <h3 className="font-bold text-lg mb-3">Ready to scale your listicle strategy?</h3>
                <p className="mb-4">
                  GetListicled helps you discover active listicles, track your coverage, and manage outreach at scale.
                  Stop missing opportunities and start building systematic authority.
                </p>
                <Link href="/search" className="inline-block bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
