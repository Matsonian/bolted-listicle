...
export default function BookLandingPage() {
  ...
  const handleSubmit = (e: React.MouseEvent | React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert('Connect this to your search functionality')
    }, 1000)
  }
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6 font-semibold">
                &quot;Spent $30K on SEO consultants. This book did more for our visibility than all of that combined. We went from zero AI mentions to being recommended in 6 different AI platforms.&quot;
              </p>
              <div className="border-t pt-4">
